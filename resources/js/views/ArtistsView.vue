...
<template>
    <div>
        ...
        <div v-if="artistsStore.loading && !artistsStore.hasArtists" class="text-center py-12">
            <p class="text-surface-400">Loading artists...</p>
        </div>
        ...
        <div v-else-if="!artistsStore.hasArtists" class="text-center py-12">
            <p class="text-surface-400">No artists found</p>
        </div>
        ...
        <div v-else class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
            <RouterLink
                ...
                class="bg-surface-800 rounded-lg p-4 hover:bg-surface-700 transition-colors group text-center"
            >
                <div class="aspect-square bg-surface-700 rounded-full mb-3 mx-auto overflow-hidden w-32 h-32">
                    <img
                        v-if="artist.image"
                        :src="artist.image"
                        :alt="artist.name"
