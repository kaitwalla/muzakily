...
<template>
    <div>
        <div v-if="albumsStore.loading && !albumsStore.currentAlbum" class="text-center py-12 bg-surface-800/50 rounded-lg" role="status">
            ...
            <span class="sr-only">Loading album...</span>
        </div>
